...
export default {
  ...
  methods: {
    ...
    loginButton() {
      ...
      axios
        .post(this.$store.state.api_url + 'login', request)
        .then(response => {
          ...
          if (this.$store.state.session.entity.type == 'Admin') {
            this.$store.state.session.navbar = [
              { to: '/', description: 'Home' },
              {
                to: '/user/' + response.data.data.profile_id,
                description:
          ...
          if (
            this.$store.state.session.entity.type == 'Manager' ||
            this.$store.state.session.entity.type == 'Rep' ||
            this.$store.state.session.entity.type == 'Farm'
          ) {
            this.$store.state.session.navbar = [
              { to: '/', description: 'Home' },
              {
