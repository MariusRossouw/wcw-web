              ...
              <div class="uk-form-stacked">
                  <div class="uk-margin">
                      ...
                      <div class="uk-form-controls">
                          <input class="uk-input" type="text" placeholder="Code" v-model="code">
                      </div>
                  </div>
                  <div class="uk-margin">
                      <label class="uk-form-label" for="form-stacked-text">Account</label>
                      <div class="uk-form-controls">
                          <input class="uk-input" type="text" placeholder="Account" v-model="account">
                      </div>
                  </div>
                  <div class="uk-margin">
                  ...
                  <div class="uk-margin">
                      ...
                      <div class="uk-form-controls">
                          <input class="uk-input" type="text" placeholder="Merchant Name" v-model="merchant_name">
                      </div>
                  </div>
                  <div class="uk-margin">
    ...
    methods: {
        updateProduct(){
            let request = {
                ...
                axios.post(this.$store.state.api_url + '/merchant_update', request)
                    .then(response => {
